...
console.log(arr);
arr.splice (2,3,21,34,54,69);//this will delete vlaues from intex 2 and delete the next 3 values then adds the given array to that spot then the remining of the original array is returned
console.log(arr);
